...
public class TestFilter implements ExchangeFilterFunction {
     ...
     */
    public TestFilter(ReactiveOAuth2AuthorizedClientManager authorizedClientManager) {
     ...
     */
    public TestFilter(ReactiveClientRegistrationRepository clientRegistrationRepository,
    ...
    private ClientRequest bearer(ClientRequest request, OAuth2AuthorizedClient authorizedClient) {
        return ClientRequest.from(request)
                            .attribute("access_token", authorizedClient.getAccessToken().getTokenValue())
                            .build();
    }
}
